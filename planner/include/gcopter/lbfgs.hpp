            ...
            */
            ...
            while (true)
            {
                ...
                */
                gnorm_inf = g.cwiseAbs().maxCoeff();
                xnorm_inf = x.cwiseAbs().maxCoeff();
                // cout << "k \t" << k << "\tg/t\t" << gnorm_inf / std::max(1.0, xnorm_inf) << "\tg\t " << gnorm_inf << "\tx\t" << xnorm_inf << endl;
                // if (k % 10000 == 0)
                //    cout << g<< endl;
                // cout << g(0) << "\t" << g(1) << "\t" <<g(2) << "\t" <<g(3) << "\t" <<g(4) << "\t" <<g(5) << "\t" << g(6) << "\t" <<endl;
                // cout << g(7) << "\t" << g(8) << "\t" <<g(9) << "\t" <<g(10) << "\t" <<g(11) << "\t" <<g(12) << "\t" << g(13) << "\t" <<endl;
                // cout << g(14) << "\t" << g(15) << "\t" <<g(16) << "\t" <<g(17) << "\t" <<g(18) << "\t" <<g(19) << "\t" << g(20) << "\t" <<endl;
                // cout << g(21) << "\t" << g(22) << "\t" <<g(23) << "\t" <<g(24) << "\t" <<g(25) << "\t" <<g(26) << "\t" << g(27) << "\t" <<endl;
                // cout << g(28) << "\t" << g(29) << "\t" <<g(30) << "\t" <<g(31) << "\t" <<g(32) << "\t" <<g(33) << "\t" << g(34) << "\t" <<endl;
                // cout << g(35) << "\t" << g(36) << "\t" <<g(37) << "\t" <<g(38) << "\t" <<g(39) << "\t" <<g(40) << "\t" << g(41) << "\t" <<endl;
                // cout << g(42) << "\t" << g(43) << "\t" <<g(44) << "\t" <<g(45) << "\t" <<g(46) << "\t" <<g(47) << "\t" << g(48) << "\t" <<endl;
                if (gnorm_inf / std::max(1.0, xnorm_inf) < param.g_epsilon)
                {
                    /* Convergence. */
                    ret = LBFGS_CONVERGENCE;
                ...
                */
                if (0 < param.past)
                {
                    ...
                    if (param.past <= k)
                    {
                        ...
                        if (isPrint == true && k % 1 == 0)
                        {
                            // cout << "k \t" << k << "\t" << rate << "\t" << param.delta << endl;
                        }
                        if (rate < param.delta)
                        {
                            ret = LBFGS_STOP;
