...
void forward( )
{
    ...
    domg0 = ddz0 * s_psi - ddz1 * c_psi - s_psi * (ddz2 * z0 + dz2 * dz0) / omg_den + c_psi * (ddz2 * z1 + dz2 * dz1) / omg_den + dz2 * dz2 * (z0 * s_psi - z1 * c_psi) / (omg_den * omg_den);
    domg1 = ddz0 * c_psi + ddz1 * s_psi - c_psi * (ddz2 * z0 + dz2 * dz0) / omg_den - s_psi * (ddz2 * z1 + dz2 * dz1) / omg_den + dz2 * dz2 * (z0 * c_psi + z1 * s_psi) / (omg_den * omg_den);
